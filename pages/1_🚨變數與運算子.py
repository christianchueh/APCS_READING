...
if st.button("送出解答"):
    ...
    st.write("**第 1 題：** (B) 20 16")
    st.write("**第 2 題：** (A) 14 -8")
    st.write("**第 3 題：** (E) 執行錯誤")
    st.write("**第 4 題：** (C) 4.5 0")
    st.write("**第 5 題：** (B) 2 3 -4")
    st.write("**第 6 題：** (A) 2 5")
    st.write("**第 7 題：** (B) 20 10")
    st.write("**第 8 題：** (B) False")
    st.write("**第 9 題：** (C) 625")
    st.write("**第 10 題：** (A) 2.5 2")
    st.write("**第 11 題：** (B) 1020")
    st.write("**第 12 題：** (A) 3 24")
    st.write("**第 13 題：** (A) True")
    st.write("**第 14 題：** (B) 3")
    st.write("**第 15 題：** (A) PythonPython")
    st.write("**第 16 題：** (B) 3.0")
    st.write("**第 17 題：** (A) 4 5")
    st.write("**第 18 題：** (A) 2")
    st.write("**第 19 題：** (A) 12.5")
    st.write("**第 20 題：** (A) 5.5")
